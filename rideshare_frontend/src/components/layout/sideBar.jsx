      ...
      <ul class="space-y-2 font-medium">
        {
            items.map((value, key) => {
                return(
                    <li>
                        <a href={value.link} class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li>
            <a href="/logout" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Log out<output></output></span>
            </a>
         </li>
      </ul>
   </div>
